...
# -------------------------------------------------------------------
# 5) Gerar LaTeX no formato do “principal” (Panel A + Panel B) – TREND ONLY
#    - Panel A: Flash Flood Post
#    - Panel B: Flash Flood 2008 ... Flash Flood 2016
#    - Observations: última linha do gen_table
# -------------------------------------------------------------------
make_workers_tex_expand_post_trend_only <- function(tab,
  ...
  # SAFE: se termo não existir (ou faltar linha do SE), deixa vazio e não quebra
