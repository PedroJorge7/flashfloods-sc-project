...
scripts_by_section <- list(
  ...
  "5. Appendix B" = c(
    ...
    "Table B.2" = "./results/code/Table B.2 Establishment-Level Estimates Including Control Variables.R",
    "Table B.3" = "./results/code/Table B.3 Establishment-Level Estimates Increasing the Post-Treatment Period.R",
    "Table B.4" = "./results/code/Table B.4 Establishment-Level Estimates Dropping Units Affected by the 2011 Floods.R",
    "Table B.6" = "./results/code/Table B.6 Establishment-Level Estimates Dropping Units Affected by the 2011 Floods.R",
    "Table B.8" = "./results/code/Table F.2 Worker Level Estimates Dropping Units that Moved Across Areas.R"
  ),
  ...
  "8. Appendix F" = c(
    ...
    "Table F.3" = "./results/code/Table F.3 Worker Level Estimates Dropping Units that Moved Across Areas.R"
  ),
