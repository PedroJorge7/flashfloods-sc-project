# ============================================================================
# Appendix B, Table B.3 — Establishment-Level Estimates Dropping Units that
# Moved Across Areas
...
log_msg("=== 03_table_B3_business_sorting.R: start ===")
...
res_closure <- fit_establishment_models(stable_panel, "morte", context = "Table B.3 / Closure")
res_reloc   <- fit_establishment_models(stable_panel, "reloc_tract_tminus1", context = "Table B.3 / Relocation")

emit_closure_relocation_table(
  res_closure, res_reloc,
  out_path = file.path(tables_dir, "Tab_B03_Dropping_Movers_5km_tract.tex"),
...
log_msg("=== 03_table_B3_business_sorting.R: done ===")
